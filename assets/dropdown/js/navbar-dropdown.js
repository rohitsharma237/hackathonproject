...
$jscomp.polyfill("Array.from", function(a) {
    return a ? a : function(a, b, d) {
        ...
        if ("function" == typeof c) {
            a = c.call(a);
            for (var f = 0; !(c = a.next()).done;) e.push(b.call(d, c.value, f++))
        } else
...
(function() {
    ...
    document.addEventListener("collapse.bs.nav-dropdown", function(a) {
        (a = a.relatedTarget.closest(".navbar-dropdown")) && (a = a.querySelector('.navbar-toggler[aria-expanded="true"]')) && a.dispatchEvent(new CustomEvent("click"))
    })
})();